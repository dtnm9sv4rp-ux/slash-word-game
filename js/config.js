...
var CONFIG = {
  ...
  BAMBOO_SEGMENT_HEIGHT: 87,       // 每节高度 (像素)
  BAMBOO_WIDTH: 87,                // 竹身粗细 (匹配方形竹节纹理)
  BAMBOO_NODE_RADIUS: 8,           // 竹节凸起半径
  ...
  BAMBOO_MIN_HEIGHT: 330,          // 竹子最小总高度 (3节)
  BAMBOO_HITBOX_PAD_X: 18,         // 水平碰撞容差
  BAMBOO_HITBOX_PAD_Y: 8,          // 垂直碰撞容差
  BAMBOO_LETTER_SIZE: 42,          // 竹节字母字号
